...
class  Question extends Component {
  ...
  // { handleSubmit, question, setQuesNumber, quesNumber, answer, setAnswers, history }
   
  handleNext = () => this.state.quesNumber<13 ? this.setState({quesNumber :this.state.quesNumber+1}) : this.state.quesNumber
    
    // setQuesNumber(prevQuestion => { return prevQuestion < 13 ? prevQuestion + 1 : prevQuestion })
     
  
    handlePrev = () => this.state.quesNumber>0 ? this.setState({quesNumber :this.state.quesNumber-1}) : this.state.quesNumber
  //   setQuesNumber(prevQuestion => { return prevQuestion > 0 ? prevQuestion - 1 : prevQuestion })
  ...
  submitAnswers =  async () => {
   ...
   this.state.quesNumber<13 ? this.setState({quesNumber :this.state.quesNumber+1}) : this.state.quesNumber
